<footer class="footer text-center fixed-bottom">
    All Rights Reserved by Corporate Office Website. Designed and Developed by <a href="https://acquaintbd.com" target="_blank">Acquaint Technologies</a>.
</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
...
<script
    src="https://corporatetechbd.com/public//backend/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js">
</script>
...
<script src="https://corporatetechbd.com/public//backend/libs/flot.tooltip/js/jquery.flot.tooltip.min.js">
</script>

<script src="https://corporatetechbd.com/public//backend/libs/jquery-validation/dist/jquery.validate.min.js">
</script>
<script src="https://corporatetechbd.com/public//backend/extra-libs/multicheck/jquery.multicheck.js"></script>
<script src="https://corporatetechbd.com/public//backend/extra-libs/multicheck/datatable-checkbox-init.js">
</script>
