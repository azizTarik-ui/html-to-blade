                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="https://corporatetechbd.com/admin">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="https://corporatetechbd.com/public/uploads/logo/Asset 1.png" width="90%"
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link waves-effect waves-dark" title="Go to website"
                                href="https://corporatetechbd.com" target="_blank">
                                <div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link waves-effect waves-dark"
                                href="https://corporatetechbd.com/admin/no_answered_question_list">
                                <div>
