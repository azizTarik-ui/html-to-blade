...
@section('main-container')
    ...
    <section class="details-banner">
        <img src="{{ url('frontend/dist/images/detailsbanner.jpg') }}" alt="Background Image" class="img-fluid w-100">
    </section>
                            ...
                            <div class="intro-start">
                                <div class="intro-start-author">
                                    <div class="author-image">
                                        <img src="{{ url('frontend/dist/images/authorsm.png') }}" alt="Author">
                                    </div>
                                        ...
                                        <a href="#">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0)">
                                                    <path d="M10.6645 2.65667H12.1252V0.112667C11.8732 0.078 11.0065 0 9.99718 0C7.89118 0 6.44851 1.32467 6.44851 3.75933V6H4.12451V8.844H6.44851V16H9.29785V8.84467H11.5278L11.8818 6.00067H9.29718V4.04133C9.29785 3.21933 9.51918 2.65667 10.6645 2.65667Z" fill="currentColor"/>
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0">
                                        ...
                                        <a href="#">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0)">
                                                        ...
                                                        <path d="M5.3335 8H10.6668" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                    </g>
                                                    <defs>
                                                            <clipPath id="clip0">
                                                                    <rect width="16" height="16" fill="white"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="blog-article-end">
                                ...
                                <img src="{{ url('frontend/dist/images/blogd01.jpg') }}" alt="Image" class="img-fluid">
                                <p>
                                ...
                                <p>
                                    “<a href="#">Essential visual design principles</a>” does a deeper dive into the principles of visual design rooted in Gestalt psychology. These fundamentals are the foundation of web and graphic design and important to know. Whether you’re designing a portfolio or a print ad, these concepts can help guide your work. Let’s do a quick recap.
                                </p>
                                <span class="lead">Emergence</span>
                                <p>
                                ...
                                <span class="lead">Reification</span>
                                <p>
                                ...
                                <span class="lead">Invariance</span>
                                <p>
                                ...
                                <h6 class="mt-lg-5">2. Typography</h6>
                                <img src="{{ url('frontend/dist/images/blogd02.jpg') }}" alt="Image" class="img-fluid">
                                <p>
                                ...
                                <p>
                                    There are plenty of resources on the web to help broaden your typographic knowledge. <a href="#" class="text-decoration-underline">FONTS IN USE</a> shows different typefaces applied to a variety of media. Tools like <a href="#" class="text-decoration-underline">Font combinations for web designers</a> can give you ideas for possible pairings.
                                </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="blog-item">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/05.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                            ...
                            <div class="comments-owner">
                                <div class="comments-owner-image">
                                    <a href="#" class="d-block">
                                        <img src="{{ url('frontend/dist/images/cowner.png') }}" alt="Image">
                                    </a>
                                </div>
