...
@section('main-container')
    <!-- Banner Starts Here -->
    @php
        $test = 'frontend/dist/images/banner.jpg';
    @endphp
    <section class="banner"
        style="background-color: #F5F5F5; background-image: url({{ $test }}); background-position: right; background-repeat: no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-01.jpg') }}" alt="Image">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 my-4 my-md-0 my-lg-0 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-02.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                ...
                <div class="col-lg-4 mt-0 mt-md-4 mt-lg-0 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-03.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                ...
                <div class="col-lg-4 mt-4 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-04.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                ...
                <div class="col-lg-4 mt-4 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-05.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                ...
                <div class="col-lg-4 mt-4 col-md-6">
                    <div class="blog-item blog-item-sm">
                        <div class="blog-item-image">
                            <a href="details.html">
                                <img src="{{ url('frontend/dist/images/sm-06.jpg') }}" alt="Image">
                            </a>
                        </div>
                        <div class="blog-item-info">
                            <span class="fs-6 has-line">Travels</span>
                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    <div class="featured-category">
                        ...
                        <div class="featured-category-item"
                            style="background-image: {{ url('frontend/dist/images/category-01.jpg') }};">
                            <a href="#">Travel</a>
                        </div>
                        <div class="featured-category-item"
                            style="background-image: {{ url('frontend/dist/images/category-02.jpg') }};">
                            <a href="#">Food</a>
                        </div>
                        <div class="featured-category-item mb-0"
                            style="background-image: {{ url('frontend/dist/images/category-03.jpg') }};">
                            <a href="#">Lifestyle</a>
                        </div>
                    </div>
                    <div class="all-tags">
